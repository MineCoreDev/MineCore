...
namespace MineCore.Structs
{
    public struct Vector3 : IVector3
    {
        ...
        {
            return (float) Math.Acos(MineCoreMath.Clamp(Dot(from.Normalized, to.Normalized), -1f, 1f)) * 57.29578f;
        }
        ...
        public static bool TryParse(string s1, string s2, string s3, NumberStyles styles, IFormatProvider provider,
            out Vector3 vector)
        {
            try
            {
